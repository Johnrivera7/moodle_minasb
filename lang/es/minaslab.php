...
$string['practice_order_hint'] = 'Pulsa cada acción en el orden correcto de trabajo.';
$string['practice_cycle_order_intro'] = 'Recorre la escena 3D: bajo la vista usa <strong>Etapas del ciclo</strong> (Perforación → Carguío → Transporte → Botadero) para enfocar cada zona. Luego ordena las tarjetas según el proceso real.';
